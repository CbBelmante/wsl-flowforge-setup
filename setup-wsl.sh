...
echo ""
echo -e "  ${YELLOW}1.${NC} Feche esta janela e abra o Ubuntu de novo — obrigatorio, nao so estetica:"
echo "     e nessa nova sessao que o zsh carrega nvm/node/claude e o PATH do flowforge"
...
echo -e "  ${YELLOW}5.${NC} Pra começar, rode:"
echo "        flowforge tui"
echo ""
